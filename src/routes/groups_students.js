...
const controllers = require('../controllers/groups_students')

const router = express.Router();

router.post('/groups/:id/students/:student_id', isLoggedIn, hasRole(['super_admin', 'admin']), controllers.postGroupsStudents);
